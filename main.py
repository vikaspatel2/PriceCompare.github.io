...
def amazon(name, amezon_name=None):
    try:
        global amazon
        name1 = name.replace(" ","-")
        name2 = name.replace(" ","+")
...
window = Tk()
window.wm_title("Price comparison website")
...
box6 =  Text(window, height=15, width=50, yscrollcommand=scrollbar.set, fg="white", cursor="hand2")
